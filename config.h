...
static char *fonts[] =
{
    "DejaVusSansM Nerd Font:size=16:antialias=true:autohint=true",
	"monospace:size=10"
};
...
static char *colors[SchemeLast][ColCount] = {
	...
	[SchemeNorm]          = { "#ebdbb2", "#282828", "norm" },
	[SchemeSel]           = { "#fabd2f", "#555555", "sel" },
	[SchemeOut]           = { "#000000", "#00ffff", "out" },
	[SchemeBorder]        = { "#add8e6", "#555555", "border" },
	[SchemePrompt]        = { "#32302f", "#af3a03", "prompt" },
	[SchemeAdjacent]      = { "#eeeeee", "#770000", "adjacent" },
	[SchemeSelHighlight]  = { "#fabd2f", "#b57614", "selhl" },
...
static unsigned int min_width  = 768; /* minimum width when centered */
...
static int vertpad = 3;
static int sidepad = 3;
